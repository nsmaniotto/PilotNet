...
from preprocess.nusceneDB import NuSceneDB
from nets.pilotNet import PilotNet
from nets.remasteredPilotNet import RemasteredPilotNet
...
# TODO : accept hyper parameters (epoch, batch size, cut layer index of PilotNet model)
def train(argv=None):
    ...
    with tf.Graph().as_default():
        ...
        with tf.Session() as sess:
            ...
            saver = tf.train.import_meta_graph("/home/smaniott/Bureau/test/model/model.ckpt.meta")
